(function(e) {
	...
	e.fn.plaxify = function(t) {
		return this.each(function() {
			var n = -1;
			var r = {
				xRange: e(this).attr("data-x") || 10,
				yRange: e(this).attr("data-y") || 20,
				invert: e(this).attr("data-invert") || false,
				background: e(this).attr("data-background") || false
			};
	...
	e.plax = {
		enable: function(t) {
			e(document).bind("mousemove.plax",
			function(n) {
				if (t) {
